-- v1b: surface the room's promotion/relegation movement counts (and whether the
-- tier is the top/bottom of the ladder) so the leagues callout can explain how
-- many members move up/down each week. Adds promote_count, relegate_count,
-- is_top, is_bottom to the room RPC's return shape.
--
