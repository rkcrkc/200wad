...
export function AnswerSoundsClient({ sounds }: AnswerSoundsClientProps) {
  ...
  return (
    <div>
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Answer Sounds</h1>
        <p className="mt-1 text-gray-600">
          Sounds played when a learner submits a test answer. Upload an MP3 (or
          any audio file, up to 2&nbsp;MB) to replace a sound, or toggle one off.
          Learners can also mute all of these from the test settings.
        </p>
      </div>
