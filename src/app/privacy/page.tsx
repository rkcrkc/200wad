...
import { LegalDoc } from "@/components/landing/LegalDoc";
    ...
    <div className="site flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <LegalDoc
          ...
          intro={
            <>
              This policy explains what personal data {BRAND_NAME} collects, why we collect it, how
              we use and share it, and the choices and rights you have. Please read it alongside our{" "}
        ...
        >
          <h2>1. Who we are</h2>
          <p>
            {BRAND_NAME} (“we”, “us”, “our”) is a language-learning service operated by{" "}
            {LEGAL_ENTITY}, a company based in Hong Kong (registration no. {COMPANY_NUMBER}),
            registered address {LEGAL_ADDRESS}. For the purposes of applicable data-protection law we
            are the “data controller” of your personal data.
          </p>
          <p>
          ...
          <p>
            We provide the service from Hong Kong. If we are required to appoint a representative in
            the UK or EEA under Article 27 of the UK/EU GDPR, we will publish their contact details in
            this policy.
          </p>
          ...
          <ul>
            <li>
              <strong>To provide the service</strong> — create your account, save your progress and
              run study/test sessions. <em>Basis: performance of a contract.</em>
            </li>
            <li>
          ...
          <p>
            Under the PDPO, we only use your data for the purposes above or a directly related one.
          </p>

          <h2>5. Cookies and analytics</h2>
          <p>
            We use strictly necessary cookies to keep you signed in and to remember basic
            preferences. We also use privacy-conscious product analytics to understand how the
            service is used. You can control non-essential cookies through your browser settings and,
            where offered, through our in-app controls. Non-essential/analytics cookies are used only
            where permitted.
          </p>
          ...
          <p>
            We operate from Hong Kong and use providers located in various regions, so your data may
            be transferred outside the UK/EEA. Where we transfer personal data of UK/EEA users, we
            rely on appropriate safeguards such as the Standard Contractual Clauses (and the UK
            Addendum) or an adequacy decision. You can ask us for more detail using the contact above.
          </p>

          <h2>8. How long we keep it</h2>
          <p>
            We keep your account and learning data for as long as your account is active. If you
            delete your account, we delete your personal data from our systems. Records that must be
            kept for a legally required period (for example billing and tax records) are retained by
            our payment processor, <strong>Stripe</strong>, for that period under its own retention
            policy; we do not keep a separate copy. Residual copies in our encrypted backups are
            overwritten in the ordinary course of our backup cycle.
          </p>

          <h2>9. Your rights</h2>
          <p>
            Subject to the applicable law, you have the right to <strong>access</strong> a copy of
            your data, to <strong>correct</strong> inaccurate data, to <strong>delete</strong> your
            data, to <strong>restrict</strong> or <strong>object</strong> to certain processing, to{" "}
            <strong>data portability</strong>, and to <strong>withdraw consent</strong> at any time
            (without affecting processing already carried out). You can exercise most of these
            directly in <Link href={appUrl("/settings")}>your account settings</Link>, or by emailing{" "}
            <a href={`mailto:${PRIVACY_EMAIL}`}>{PRIVACY_EMAIL}</a>.
          </p>
          <p>
            If you are in the UK/EEA and believe we have mishandled your data, you may complain to
            your local supervisory authority (in the UK, the Information Commissioner’s Office at
            ico.org.uk). If you are in Hong Kong, you may contact the Office of the Privacy
            Commissioner for Personal Data (PCPD) at pcpd.org.hk. We would appreciate the chance to
            resolve your concern first.
          </p>

          <h2>10. Security</h2>
          <p>
            We use technical and organisational measures to protect your data, including encryption in
            transit, hashed passwords, access controls and row-level security on our database. No
            system is perfectly secure, but we work to protect your information and to notify you and
            the relevant authority if a breach legally requires it.
          </p>
          ...
          <h2>13. Contact us</h2>
          <p>
            Privacy questions: <a href={`mailto:${PRIVACY_EMAIL}`}>{PRIVACY_EMAIL}</a>. General
            support: <a href={`mailto:${SUPPORT_EMAIL}`}>{SUPPORT_EMAIL}</a>. Postal address:{" "}
