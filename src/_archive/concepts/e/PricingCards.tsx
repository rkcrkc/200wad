...
/**
 * Brand-skinned pricing for Concept E.
  ...
  return (
    <div>
      ...
      <div className="flex justify-center">
        <div className="inline-flex rounded-[var(--r-pill)] border-2 border-[var(--ink)] bg-[var(--card)] p-1 shadow-[var(--shadow-sm)]">
          {(["monthly", "annual"] as const).map((b) => (
            <button
              key={b}
              onClick={() => setBilling(b)}
              className={`rounded-[var(--r-pill)] px-4 py-1.5 text-sm font-bold capitalize ${
