...
export async function getWord(wordId: string): Promise<{
  ...
  const wordWithDetails: WordWithDetails = {
    ...
    picture_mp4_defect: word.picture_mp4_defect,
    audio_rerecord_english: word.audio_rerecord_english,
    audio_rerecord_english_male: word.audio_rerecord_english_male,
    audio_rerecord_english_female: word.audio_rerecord_english_female,
    audio_rerecord_foreign: word.audio_rerecord_foreign,
    audio_rerecord_foreign_male: word.audio_rerecord_foreign_male,
    audio_rerecord_foreign_female: word.audio_rerecord_foreign_female,
    audio_rerecord_trigger: word.audio_rerecord_trigger,
    audio_rerecord_trigger_male: word.audio_rerecord_trigger_male,
    audio_rerecord_trigger_female: word.audio_rerecord_trigger_female,
